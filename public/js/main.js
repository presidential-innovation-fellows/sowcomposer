...
(function() {
  ...
  $(function() {
    ...
    $(".datepicker input").each(function() {
      if ($(this).val() === '') {
        return $(this).closest(".controls, li").find(".tbd-checkbox").attr('checked', true);
      }
    });
  ...
  $(document).on("click", "input.tbd-checkbox", function() {
    var input;
    input = $(this).closest(".controls, li").find(".datepicker input");
    if (this.checked) {
      return input.val('');
    } else {
      return input.val(input.parent().data('date'));
    }
  });
